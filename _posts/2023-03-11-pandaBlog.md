...
&emsp;&emsp; 用户在浏览器看到的网页页面内容就是网页的前端，而网页的后端实际上就是服务器端。网页的数据都是存储在服务器中，当用户在浏览器输入某个网页的地址时，网址实际上会被解析成网站服务器的IP地址，通过IP地址访问该服务器的时候会发出打开某一具体网页的请求。然后服务器对该请求进行响应，返回相应网页的资源（如网页源码和图片），
